...
- **[QwenScope](https://github.com/zactheaipm/qwenscope)** - trains Sparse Autoencoders (SAEs) on the residual stream of Qwen 3.5-27B — a 64-layer hybrid model that interleaves GatedDeltaNet (linear attention) and standard attention layers — to identify, decompose, and steer five core behavioral traits of agentic language model behavior.
